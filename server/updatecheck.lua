...
local resourceName = "es.lib"

CreateThread(function()
    if GetCurrentResourceName() ~= "es.lib" then
        resourceName = "es.lib (" .. GetCurrentResourceName() .. ")"
    end
end)

CreateThread(function()
    while true do
        PerformHttpRequest("https://api.github.com/repos/ESFramework/es.lib/releases/latest", CheckVersion, "GET")
        Wait(3600000)
    end
end)
...
GetRepoInformations = function()
    ...
    PerformHttpRequest("https://api.github.com/repos/ESFramework/es.lib/releases/latest", function(err, response, headers)
        if err == 200 then
            ...
            repoURL = "https://github.com/ESFramework/es.lib"
        end
    end, "GET")
